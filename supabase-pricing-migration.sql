...
VALUES ('ai_question_per_type', '실전변형 문제 (유형당)', 20, '유형 1개당', true)
...
-- 2. 지문분석 툴/워크북: 50 CON
INSERT INTO con_pricing (feature_key, feature_name, cost_per_use, unit_description, is_active)
VALUES ('pdf_analysis', '지문분석 툴 / 워크북', 50, '1회 분석당', true)
ON CONFLICT (feature_key) DO UPDATE
  SET feature_name = EXCLUDED.feature_name,
      cost_per_use = EXCLUDED.cost_per_use,
      unit_description = EXCLUDED.unit_description,
...
INSERT INTO con_pricing (feature_key, feature_name, cost_per_use, unit_description, is_active)
VALUES ('sms', 'SMS 문자 (단문)', 2, '건당', true)
ON CONFLICT (feature_key) DO UPDATE
  SET feature_name = EXCLUDED.feature_name,
      cost_per_use = EXCLUDED.cost_per_use,
      unit_description = EXCLUDED.unit_description,
...
-- 4. LMS 장문: 4 CON (신규)
INSERT INTO con_pricing (feature_key, feature_name, cost_per_use, unit_description, is_active)
VALUES ('lms', 'LMS 문자 (장문)', 4, '건당', true)
ON CONFLICT (feature_key) DO UPDATE
  SET feature_name = EXCLUDED.feature_name,
      cost_per_use = EXCLUDED.cost_per_use,
      unit_description = EXCLUDED.unit_description,
