...
export async function middleware(request: NextRequest) {
  ...
  const aiAllowed = ['/admin/pdf-editor', '/admin/mock-exam-workbook', '/admin/ai-questions', '/admin/mock-exam-questions', '/admin/account', '/admin/notices', '/admin/inquiries', '/admin/vocab-choice'];
