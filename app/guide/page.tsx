  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        step: '충전',
        title: 'CON 충전 방법',
        desc: 'CON 충전은 운영팀에게 문의하세요. CON이 부족한 경우 문제 생성이 차단되며 충전 안내 팝업이 표시됩니다.',
      },
    ],
    note: 'CON 잔액이 부족하면 기능 사용이 제한됩니다. 넉넉한 CON을 유지하면 수업 준비를 끊김 없이 진행할 수 있습니다.',
  },
];
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              ...
              { q: 'CON은 어디서 충전하나요?', a: '고객센터(문의하기 메뉴)로 문의하시면 충전 안내를 받을 수 있습니다.' },
            ].map((faq, i) => (
