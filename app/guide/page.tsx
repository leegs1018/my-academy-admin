...
const sections = [
  {
    ...
    steps: [
      {
        step: '직접 입력 탭',
        title: '지문 직접 입력',
        desc: '분석할 영어 지문을 텍스트로 붙여넣거나 이미지 파일을 업로드하세요. OCR 기술로 자동 추출됩니다. 난이도를 선택 후 AI 분석을 실행하면 변형 지문(파라프레이징), T/F 문장, 어휘 목록, 한 문장 요약 등이 자동 생성됩니다.',
      },
      {
        step: '모의고사 지문 탭',
        title: '기출 지문으로 분석하기',
      ...
      {
        step: '결과 확인 및 편집',
        title: '워크북 확인 및 인라인 편집',
        desc: '변형 지문, T/F 문장, 어휘 목록, 요약 등 생성된 내용을 확인합니다. 항목을 직접 클릭해 인라인 편집이 가능하며, 편집 내용이 PDF에 그대로 반영됩니다.',
      },
      {
        step: '생성 이력 탭',
    ...
    note: '지문 분석 1회 시 CON이 소모됩니다. 직접 입력과 모의고사 지문 탭 모두 동일한 CON이 사용됩니다.',
  },
  {
    number: '02',
    icon: '📌',
    ...
    steps: [
      {
        step: '지문 입력',
        title: '텍스트 또는 이미지로 지문 입력',
        desc: '영어 지문을 텍스트로 입력하거나 이미지를 업로드하세요. OCR로 자동 추출됩니다. 지문 추가 버튼으로 여러 지문을 동시에 처리할 수 있습니다. 모의고사 탭에서 기출 지문을 바로 불러올 수도 있습니다.',
      },
      {
        step: '유형 선택',
        title: '카테고리별 워크북 유형 선택',
        desc: '지문 드릴(지문 해석지·구문분석·문장 해석·단어 배열·영작), 어휘 어법(어휘 고르기·채우기·어법 고르기·고치기·심화), 서술형 대비(요약문 서술형 등) 중 원하는 유형을 복수 선택합니다.',
      },
      {
        step: '난이도 선택',
        title: '난이도 설정 (B1~C2)',
        desc: '지문 수준에 맞는 난이도를 선택합니다. B1(중등/고등 하) · B2(고등 중) · C1(고등 상) · C2(고등 최상)으로 구분됩니다.',
      },
      {
        step: '생성 이력 탭',
        title: 'PDF 배치 방식 선택 및 이력 관리',
        desc: '문제지·정답지 PDF를 지문별 / 유형별 / 무작위 배치 방식으로 선택해 다운로드합니다. 생성 이력 탭에서 이전 작업물을 재다운로드하거나 삭제할 수 있습니다.',
      },
    ],
    note: '유형 수×지문 수만큼 CON이 차감됩니다. 한 번에 여러 지문과 유형을 선택하면 수업 자료를 효율적으로 제작할 수 있습니다.',
  },
  {
    number: '03',
    icon: '🎯',
    ...
    steps: [
      {
        ...
        desc: '영어 지문을 텍스트 또는 이미지로 입력하세요. 지문 추가 버튼으로 여러 개 지문을 한 번에 처리할 수 있습니다. 유형(10가지), 난이도(A2~C2), 문제 수(1~3개)를 유형별로 각각 설정한 후 생성하세요.',
      },
      {
        step: '모의고사 지문 탭',
    ...
    note: '유형별 개수만큼 CON이 차감됩니다. 생성 실패 시 CON은 차감되지 않으며 자동으로 재시도합니다.',
  },
  {
    number: '04',
    icon: '💰',
    ...
    steps: [
      ...
      },
      {
        step: '소모량',
        title: '기능별 CON 소모량',
        desc: '지문분석, 워크북, 실전 변형 문제 사용 시 CON이 차감됩니다. 정확한 차감량은 각 화면의 CON 안내를 확인하세요.',
      },
      {
        step: '환불',
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <div className="max-w-4xl mx-auto px-8 pb-20 space-y-16">
        ...
        {/* 문제 유형 안내 */}
        <section>
          <h2 className="text-2xl font-black text-slate-900 mb-6">실전 변형 문제 지원 유형 (10가지)</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {[
              ...
              { icon: '📍', label: '문장 삽입 유형', desc: '주어진 문장이 들어갈 위치 찾기' },
            ].map((t, i) => (
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              ...
              { q: '워크북 유형이 일부만 보여요.', a: '슈퍼어드민이 활성화한 유형만 선택 목록에 표시됩니다. 필요한 유형이 보이지 않으면 담당자에게 문의하세요.' },
