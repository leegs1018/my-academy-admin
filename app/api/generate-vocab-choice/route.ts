...
2. 각 위치에 [어휘1 / 어휘2 / 어휘3] 형식으로 3개의 선택지를 만든다. 정답 1개 + 오답 2개, 순서는 무작위.
...
{
  "vocab_choice_passage": "지문 텍스트. 선택 어휘 위치에 1[어휘1 / 어휘2 / 어휘3] 형식으로 삽입. 예: The scientist 1[discovered / invented / created] a new method",
